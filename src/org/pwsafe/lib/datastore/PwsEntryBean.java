/*
 *  * $Id: PwsEntryBean.java 499 2014-02-03 19:52:29Z roxon $
 *
...
public class PwsEntryBean implements Cloneable {
	private static final Log log = Log.getInstance(PwsEntryBean.class); //LogFactory.getLog(PwsEntryBean.class);
