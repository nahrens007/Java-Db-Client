/*
 * $Id: PwsTimeField.java 488 2013-12-11 23:22:25Z roxon $
 * 
...
public class PwsTimeField extends PwsField {
	...
	/**
	 * Compares this <code>PwsTimeField</code> to another returning a value less
	...
	public int compareTo(Object that) {
		return ((Date) getValue()).compareTo((Date) ((PwsTimeField) that).getValue());
	}
	...
	/**
	 * Compares this object to a <code>java.util.Date</code> returning
	 * <code>true</code> if they're equal or <code>false</code> otherwise.
	 * 
	 * @param arg0 the other object to compare to.
	 * 
