/*
 * $Id: PwsRecordV2.java 488 2013-12-11 23:22:25Z roxon $
 * 
...
public class PwsRecordV2 extends PwsRecord {
	...
	private static Map<PwsFieldTypeV2, Class<? extends PwsField>> field_map = new EnumMap<PwsFieldTypeV2, Class<? extends PwsField>>(
			PwsFieldTypeV2.class);
	static {
	...
	private static final Object[] VALID_TYPES = new Object[] {
			...
			new Object[] { new Integer(PASSWORD_LIFETIME), "PASSWORD_LIFETIME",
	...
	protected void saveRecord(PwsFile file) throws IOException {
		...
		for (final Iterator iter = getFields(); iter.hasNext();) {
			int type;
			PwsField value;
