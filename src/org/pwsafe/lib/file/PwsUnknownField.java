...
/**
 * Bit bucket for fields we are not interested in processing but must preserve
 * in the output.
 * 
...
public class PwsUnknownField extends PwsField {
	...
	public int compareTo(Object that) {
		final byte[] thisB = (byte[]) getValue();
		final byte[] thatB = (byte[]) ((PwsUnknownField) that).getValue();
