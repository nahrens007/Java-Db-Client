...
/**
 * Provides a wrapper for fields that hold an integer value such as the date and
 * time fields. Integer values are stored in the database in little-endian order
 * and are converted to and from this format on writing and reading.
 * 
 * @author Kevin Preece
 */
public class PwsIntegerField extends PwsField {
	...
	/**
	 * Returns this integer as an array of bytes. The returned array will have a
	 * length of PwsFile.BLOCK_LENGTH and is thus suitable to be written to the
	 * database.
	 * 
	 ...
	 * Integer. It returns <code>true</code> if they are equal and
	 ...
	 * returns <code>true</code> if they are equal and <code>false</code> if
	 * they're unequal.
	 * 
	 ...
	 * <code>true</code> if they are equal and <code>false</code> if they're
	 * unequal.
	 * 
