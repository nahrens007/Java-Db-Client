/*
 * $Id: PwsUUIDField.java 488 2013-12-11 23:22:25Z roxon $
 * 
...
public class PwsUUIDField extends PwsField {
	...
	/**
	 * Compares this <code>PwsUUIDField</code> to another returning a value less
	 * than zero if <code>this</code> is "less than" <code>that</code>, zero if
	...
	public int compareTo(Object that) {
		return ((UUID) getValue()).compareTo((UUID) ((PwsUUIDField) that).getValue());
	}

	/**
	 * Compares this object to another <code>PwsUUIDField</code> or {@link UUID}
	...
	/**
	 * Compares this object to a {@link UUID} returning <code>true</code> if
