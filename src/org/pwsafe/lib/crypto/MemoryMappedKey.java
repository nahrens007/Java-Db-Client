...
/**
 * Tries to hide create a key which is hidden from an occasional onlooker. Uses
 * a memory mapped temporary file to distribute the key data.
 * <p>
 * It's unchecked whether this makes any difference for swapped out memory.
 * <p>
 * <b>NOTE:</b> ATM, the temporary file is probably not deleted! On Windows,
