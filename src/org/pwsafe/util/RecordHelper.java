/*
 * $Id: RecordHelper.java 488 2013-12-11 23:22:25Z roxon $
 * 
...
public class RecordHelper {
	...
	/**
	 * Finds the node named <code>name</code>. Name is an empty string or a list
	 * of node names, separated by 'dots', e.g. "bank.online". Nodes are created
	 * as necessary if they don't exist.
	 * 
	...
	/**
	 * Returns the records from file as a heirarchical tree structure of
	...
	/**
	 * Returns the records from file in a heirarchical tree-like structure. The
	 * root node is a <code>HasMap</code> which can have zero or more nodes as
	 * entries. Nodes which themselves have further sub-entries are stored as a
	 * <code>HashMap</code>. Leaf nodes are stored as the {@link PwsRecord}.
	 * E.g. </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Note, however, that PasswordSafe files in V1.x format don't have groups.
	 * Therefore this method will simply return a flat heirarchy.
	 * 
	 * @param file the file to get the records from.
	 * 
	 * @return
	 * 
	 * @throws UnsupportedFileVersionException if <code>file</code> is not a V1
	 *         or V2 file.
	 */
	public static HashMap recordsAsTree(PwsFile file) throws UnsupportedFileVersionException {
	...
	private static HashMap recordsAsTreeV1(PwsFileV1 file) {
		...
		for (final Iterator iter = file.getRecords(); iter.hasNext();) {
			PwsRecordV1 rec;
